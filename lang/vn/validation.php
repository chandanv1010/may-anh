...
return [
    /*
    |--------------------------------------------------------------------------
    | Validation Language Lines - Thông báo xác thực
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau đây chứa các thông báo lỗi mặc định được sử dụng bởi
    | lớp validator. Một số quy tắc này có nhiều phiên bản như quy tắc kích thước.
    | Bạn có thể tùy chỉnh từng thông báo này tại đây.
    |
    */
    ...
    'ascii' => 'Trường :attribute chỉ được chứa các ký tự và biểu tượng chữ-số một byte.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom Validation Language Lines - Thông báo xác thực tùy chỉnh
    |--------------------------------------------------------------------------
    |
    ...
    | nhanh chóng chỉ định một dòng ngôn ngữ tùy chỉnh cụ thể cho một quy tắc thuộc tính.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom Validation Attributes - Thuộc tính xác thực tùy chỉnh
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau được sử dụng để thay thế placeholder thuộc tính
    | bằng thứ gì đó thân thiện hơn với người đọc như "Địa chỉ E-Mail" thay vì
    | "email". Điều này chỉ đơn giản giúp chúng ta làm cho thông báo biểu cảm hơn.
    |
    */
