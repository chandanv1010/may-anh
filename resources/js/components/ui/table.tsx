  ...
  return (
    <th
      ...
      className={cn(
        ...
        // Chỉ thêm text-left nếu không có text-center trong className
  ...
  return (
    <td
      ...
      className={cn(
        ...
        // Xóa whitespace-nowrap mặc định, cho phép text wrap
        // Nếu cần giữ nowrap, có thể thêm whitespace-nowrap vào className của TableCell cụ thể
        className
      )}
      {...props}
    />
