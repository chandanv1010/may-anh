...
import { UserCatalogue } from './save';
...
const pageConfig: PageConfig<UserCatalogue> = {
    ...
    cardDescription: 'Quản lý thông tin danh sách nhóm thành viên, sử dụng các chức năng để lọc dữ liệu vv...',
    filters: [...filter],
    columns: [
...
export default function UserCatalogueIndex({users, records}: IUserCatalogueIndexProps) {
    ...
    const {
        ...
        handleCheckItem,
        setSelectedIds
     } = useTable<UserCatalogue>({pageConfig, records: records.data})
