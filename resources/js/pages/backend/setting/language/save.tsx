                    ...
                    <div className="grid grid-cols-12 gap-4">
                        ...
                        <div className="col-span-7">
                            <Form 
                                ...
                                action={
                                    isEdit ? language.update(record.id) : language.store()
                                }
                                method="post"
                                        ...
                                        >
                                            <div className="grid grid-cols-2 gap-4 mb-[20px]">
                                                <div className="col-span-1">
                                                    <Label htmlFor="name" className="mb-[10px]">Tên ngôn ngữ</Label>
                                                    <Input
                                                        id="name"
                                                        type="text"
                                                        name="name"
                                            ...
                                            <div className="grid grid-cols-1 gap-4 mb-[20px]">
                                                <div className="col-span-1">
                                                    <Label htmlFor="image" className="mb-[10px]">Ảnh Đại Diện</Label>
                                                    <div>
