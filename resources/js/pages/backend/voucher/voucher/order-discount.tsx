...
interface OrderDiscountVoucher {
    id?: number
    code: string
    name: string
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Thêm mới voucher giảm giá đơn hàng', href: '/' },
]
...
export default function OrderDiscount({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={isEdit ? 'Cập nhật voucher giảm giá đơn hàng' : 'Thêm mới voucher giảm giá đơn hàng'} />
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl page-wrapper">
                <CustomPageHeading
                    heading={isEdit ? 'Cập nhật voucher giảm giá đơn hàng' : 'Thêm mới voucher giảm giá đơn hàng'}
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    ...
                                                    {discountType === 'percentage' && (
                                                        <div className="mt-2">
                                                            <Label htmlFor="max_discount_value" className="text-sm">
                                                                Giảm giá tối đa (VNĐ) <span className="text-gray-500">(Tùy chọn)</span>
                                                            </Label>
                                    ...
                                    <div className="lg:col-span-1 space-y-6">
                                        ...
                                        <PromotionOverview
                                            ...
                                            items={[
                                                { label: 'Loại voucher', value: <strong>Giảm giá đơn hàng</strong> },
